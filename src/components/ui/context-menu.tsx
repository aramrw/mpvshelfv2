...
export const ContextMenuSubTrigger = <T extends ValidComponent = "div">(
  ...
  return (
    <ContextMenuPrimitive.SubTrigger
      class={cn(
        "font-medium flex cursor-default select-none items-center rounded-sm px-1.5 py-0.5 text-sm outline-none focus:bg-muted focus:text-accent-foreground data-[expanded]:bg-muted data-[expanded]:text-accent-foreground",
        local.inset && "pl-8",
        local.class,
      )}
      {...rest}
  ...
  return (
    <ContextMenuPrimitive.Portal>
      <ContextMenuPrimitive.SubContent
        class={cn(
          "outline-none z-50 min-w-[8rem] overflow-hidden rounded-md border bg-popover p-1 text-popover-foreground shadow-lg data-[expanded]:animate-in data-[closed]:animate-out data-[closed]:fade-out-0 data-[expanded]:fade-in-0 data-[closed]:zoom-out-95 data-[expanded]:zoom-in-95",
          local.class,
        )}
        {...rest}
      />
  ...
  return (
    <ContextMenuPrimitive.Portal>
      <ContextMenuPrimitive.Content
        class={cn(
          "outline-none z-50 min-w-[8rem] overflow-hidden rounded-md border bg-popover p-1 text-popover-foreground shadow-md transition-shadow data-[expanded]:animate-in data-[closed]:animate-out data-[closed]:fade-out-0 data-[expanded]:fade-in-0 data-[closed]:zoom-out-95 data-[expanded]:zoom-in-95",
          local.class,
        )}
        {...rest}
      />
