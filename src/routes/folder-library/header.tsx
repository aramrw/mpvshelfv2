...
export default function ({ mainParentFolder, user }: { mainParentFolder: OsFolder; user: UserType }) {
  ...
  return (
    <header class="sm:px-2 md:px-16 lg:px-30 xl:px-40 w-full h-fit py-3 px-2 relative">
      ...
      <div class="relative w-fit flex items-start gap-2">
        {" "}
        ...
        <Show when={mainParentFolder.title && mainParentFolder.last_watched_video}>
          <img
            ...
            class="select-none object-contain
              ...
              w-auto z-30 rounded-sm
              border-white/10 border-2 shadow-md"
          />
          <svg
            class="text-secondary fill-secondary/80 bg-primary/70 rounded-sm hover:opacity-50 transition-all
